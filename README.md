...
if you also want to use the good-looking [swaylock-fancy](https://github.com/Big-B/swaylock-fancy), and if you are an Arch Linux user, you can simply install it by
